...
delete from payment_route_hops a where hops_order != 0 and hops_order != (select max(hops_order) from payment_route_hops b where a.payment_route_jpa_dto_route_id = b.payment_route_jpa_dto_route_id);
