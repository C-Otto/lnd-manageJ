...
public  class UnresolvedClosedChannelFixtures {
    public static final UnresolvedClosedChannel CLOSED_CHANNEL = new UnresolvedClosedChannel(CHANNEL, PUBKEY);
    ...
    public static final UnresolvedClosedChannel CLOSED_CHANNEL_2 = new UnresolvedClosedChannel(CHANNEL_2, PUBKEY);
    public static final UnresolvedClosedChannel CLOSED_CHANNEL_3 = new UnresolvedClosedChannel(CHANNEL_3, PUBKEY);
}
