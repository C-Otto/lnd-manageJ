...
class ChannelControllerIT {
    ...
    void getChannelDetails() throws Exception {
        ...
        mockMvc.perform(get(DETAILS_PREFIX))
                ...
                .andExpect(jsonPath("$.rebalanceReport.sourceCostsMilliSat", is("1001000")))
                .andExpect(jsonPath("$.rebalanceReport.sourceAmountMilliSat", is("666000")))
                .andExpect(jsonPath("$.rebalanceReport.targetCostsMilliSat", is("2001000")))
                .andExpect(jsonPath("$.rebalanceReport.targetAmountMilliSat", is("992000")))
                .andExpect(jsonPath("$.rebalanceReport.supportAsSourceAmountMilliSat", is("101000")))
                .andExpect(jsonPath("$.rebalanceReport.supportAsTargetAmountMilliSat", is("201000")))
                ...
                .andExpect(jsonPath("$.flowReport.receivedViaPaymentsMilliSat", is("1")))
                .andExpect(jsonPath("$.flowReport.totalSentMilliSat", is("70006")))
                .andExpect(jsonPath("$.flowReport.totalReceivedMilliSat", is("63021")))
